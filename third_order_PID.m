...
%                                                %%%%%%%%%%%%%%%%%%%%%%%
% PID controller and simulation of third-order system
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Kp = 0.072;             % proportional term Kp
Ki = 0.4;           % Integral term Ki
Kd = 0.625;           % derivative term Kd
...
Time = 25;          % total simulation time in seconds
...
for i = 1:n
    ...
    x3_dot(i+1) = -x1(i)-x2(i)-x3(i)+u(i);
    x2_dot(i+1) = x3(i);
    
    % Integrate the x_dots to calculate the present state
    x3(i+1) = x3(i)+x3_dot(i+1)*dt;
